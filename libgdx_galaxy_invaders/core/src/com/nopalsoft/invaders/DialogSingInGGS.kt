...
class DialogSingInGGS(val game: MainInvaders, private var stage: Stage) {
    ...
    fun showDialogSignIn() {
        dialogSignIn = Dialog(Assets.languages?.get("sign_in"), Assets.styleDialogPause)
        val labelContent = Label(
            Assets.languages?.get("sign_in_with_google_to_share_your_scores_and_achievements_with_your_friends"),
        ...
        val buttonSignIn = TextButton(Assets.languages?.get("sign_in"), style)
        buttonSignIn.label.wrap = true
        val buttonNotNow = TextButton(Assets.languages?.get("not_now"), Assets.styleTextButton)
    ...
    fun showDialogRate() {
        dialogRate = Dialog(Assets.languages?.get("please_rate_the_app"), Assets.styleDialogPause)
        val lblContenido = Label(
            Assets.languages?.get("thank_you_for_playing_if_you_like_this_game_please"),
            Assets.styleLabelDialog
        )
        ...
        val rate = TextButton(Assets.languages?.get("rate"), Assets.styleTextButton)
        val btNotNow = TextButton(Assets.languages?.get("not_now"), Assets.styleTextButton)
        rate.height = 10f
